...
<div class="card">
  <h5 class="card-header"> <a href="<?= BASE; ?>/listas.php" class="btn btn-primary"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Turma <?php echo $dado['titulo']; ?></a> Planos de Aula</h5>
  <div class="card-body">
    <div class="card-text">
    <form method="POST">
